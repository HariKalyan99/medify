...
const Herocontainer = () => {
  return (
    <div className='container d-flex w-100 justify-content-center align-items-start heroDiv'>
          <div className=' h-100 medCenterDiv' style={{marginTop: "120px"}}>
            <h1 style={{fontSize: "31px"}} className='fs-5 fs-lg-1 pt-md-5'>Skip the travel! Find Online</h1>
          ...
          <div className=' h-100 w-100 d-flex justify-content-center align-content-center'>
            <img src={heroImg} alt="hero_image" className='heroImage'/>
          </div>
        </div>
  )
}
